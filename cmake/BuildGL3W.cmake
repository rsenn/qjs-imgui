  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/gl3w")
    ...
    ExternalProject_Add(
      ...
      CMAKE_ARGS -DBUILD_SHARED_LIBS:BOOL=OFF "-DCMAKE_BUILD_TYPE:STRING=${CMAKE_BUILD_TYPE}" "-DCMAKE_POSITION_INDEPENDENT_CODE:BOOL=${CMAKE_POSITION_INDEPENDENT_CODE}"
                 "-DCMAKE_C_COMPILER:STRING=${CMAKE_C_COMPILER}" "-DCMAKE_C_FLAGS:STRING=${CMAKE_C_FLAGS} ${MODULE_COMPILE_FLAGS}" -DGL3W_BUILD_DOCS:BOOL=OFF -DGL3W_BUILD_EXAMPLES:BOOL=OFF
